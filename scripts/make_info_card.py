...
ROWS = [
    ("", ""),
    ("Name", "Nicolás Hernández Faéz"),
    ("Location", "London, UK"),
    ("Role", "Quantitative Data Analyst"),
    ("", ""),
    ("Education", "MSc Applied Social Data Science, LSE"),
    ("Before", "Data analyst @ UN ECLAC (CEPAL)"),
    ("", ""),
    ("Stack", "SQL · Python · R · Power BI"),
    ("Cloud", "Google Cloud Platform (BigQuery)"),
    ("Modeling", "Segmentation & clustering · propensity"),
    ("", "predictive models · causal inference"),
    ("", ""),
    ("Focus", "Harmonizing messy data at scale"),
    ("", "and making it decision-ready"),
    ("", ""),
    ("Contact", "nicolashernandez.fa@gmail.com"),
    ("GitHub", "github.com/nicohernandez02"),
]
